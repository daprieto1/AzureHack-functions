 ...
 */
class VaultCreateOrUpdateParameters extends models['BaseResource'] {
  /**
   * Create a VaultCreateOrUpdateParameters.
   ...
   * whether recoverable deletion is enabled for this key vault. Setting this
   * property to true activates the soft delete feature, whereby vaults or
   * vault entities can be recovered after deletion. Enabling this
