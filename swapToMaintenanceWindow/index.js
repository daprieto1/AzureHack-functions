...
module.exports = function (context, req) {
    ...
    var slot = {
        "targetSlot": "MaintenanceWindow",
        "preserveVnet": false
    }

    webSiteClient.webApps.swapSlotWithProduction(resourceGroupName, webAppName, slot, null, function (err, result) {
        if (err) context.res = { status: 500, body: err }
        data.result = result
        context.res = data
        axios.post('https://61ba7e6f.ngrok.io/maintenance', context.res)
        context.done();
    })
};